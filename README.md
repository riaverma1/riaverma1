...
|---|---|---|---|
| **Jarvis** <br> Autonomous GitHub Coding Agent. | An autonomous agent that watches GitHub issues, writes code to fix them, and opens draft PRs — all in the background. Runs locally so there are no security concerns at work, and nothing merges without your approval. Built at a company hackathon. Full [PRD](./jarvis-prd.md) attached if you want to build your own. | ![hackathon](https://img.shields.io/badge/hackathon-e36209?style=flat-square) | [PRD →](./jarvis-prd.md) |
