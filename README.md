...
|---|---|---|---|
| **BtwnMeetings** <br> Finding next workspace between meetings. | A WFH coffee shop finder web app — a Google Maps interface that shows laptop-friendly coffee shops with wifi/outlets/WFH scores. | ![deployed app](https://img.shields.io/badge/deployed%20app-2da44e?style=flat-square) | [repo →](https://github.com/riaverma1/coffee_app) |
